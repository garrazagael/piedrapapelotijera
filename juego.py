...
image_winner = cv2.imread("ganador.jpg")
image_tie = cv2.imread("empate.png")
image_loser = cv2.imread("perdedor.jpg")
# Image to concat
imAux = image1
player = None
...
with mp_hands.Hands(
     ...
     while True:
          ...
          # Resize frame to have the same dimensions as imAux
          frame_resized = cv2.resize(frame, (imAux.shape[1], imAux.shape[0]))

         # Concatenate imAux and frame_resized
          n_image = cv2.hconcat([imAux, frame_resized])
